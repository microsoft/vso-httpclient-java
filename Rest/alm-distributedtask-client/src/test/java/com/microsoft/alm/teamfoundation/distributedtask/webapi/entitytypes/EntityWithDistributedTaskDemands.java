...
package com.microsoft.alm.teamfoundation.distributedtask.webapi.entitytypes;

import com.microsoft.alm.teamfoundation.distributedtask.webapi.Demand;

public class EntityWithDistributedTaskDemands {
    ...
    public boolean equals(final Object obj) {
        if (!(obj instanceof EntityWithDistributedTaskDemands)) {
            return false;
        }

        final EntityWithDistributedTaskDemands o = (EntityWithDistributedTaskDemands) obj;
