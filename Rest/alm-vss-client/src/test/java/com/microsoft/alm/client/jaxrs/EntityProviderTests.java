...
public class EntityProviderTests
    ...
    public void testIsReadable() {
        ...
        assertTrue(MediaType.APPLICATION_JSON,
    ...
    @Test
    public void testClassEntityReading()
        ...
        final Object v2 =
            bodyProvider.readFrom((Class<Object>) v1.getClass(), (Class<Object>) v1.getClass(), null,
                MediaType.APPLICATION_JSON_TYPE, null, TestUtil.toInputStream(s));
    ...
    @Test
    public void testAttributedClassEntityReading()
        throws WebApplicationException,
            IOException {
        MessageBodyReader<Object> bodyProvider = new ApiResourceEntityProvider();
    ...
    @Test
    public void testEntityListReading()
        throws WebApplicationException,
            IOException {
        MessageBodyReader<Object> bodyProvider = new ApiResourceEntityProvider();
        ...
        @SuppressWarnings("unchecked")
        final Object v2 =
            bodyProvider.readFrom((Class<Object>) v1.getClass(), genericType, null, MediaType.APPLICATION_JSON_TYPE,
                null, TestUtil.toInputStream(s));
    ...
    @Test
    public void testEnumEntityReading()
        throws WebApplicationException,
            IOException {
        MessageBodyReader<Object> bodyProvider = new ApiResourceEntityProvider();
