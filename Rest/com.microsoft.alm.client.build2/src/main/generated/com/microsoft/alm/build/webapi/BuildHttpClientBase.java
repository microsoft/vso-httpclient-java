...
public abstract class BuildHttpClientBase
    ...
    */
    ...
    /** 
     * [Preview API 2.1-preview.2] Gets the changes associated between given builds
     * 
     * @param project 
     *            Project ID or project name
     * @param fromBuildId 
    ...
    public List<Change> getChangesBetweenBuilds(
        ...
        final ApiResourceVersion apiVersion = new ApiResourceVersion("2.1-preview.2"); //$NON-NLS-1$
    ...
    /** 
     * [Preview API 2.1-preview.2] Gets all the work item ids inbetween fromBuildId to toBuildId
     * 
     * @param project 
     *            Project ID or project name
     * @param fromBuildId 
