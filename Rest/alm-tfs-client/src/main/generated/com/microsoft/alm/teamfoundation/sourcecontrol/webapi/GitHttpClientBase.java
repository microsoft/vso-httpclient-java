...
public abstract class GitHttpClientBase
    ...
    */
    ...
    /** 
     * [Preview API 3.0-preview.1] Retrieve deleted git repositories.
     * 
     * @param project 
     *            Project ID or project name
    ...
    /** 
     * [Preview API 3.0-preview.1] Create a pull request iteration status
     * 
     * @param status 
     *            
     * @param repositoryId 
    ...
    /** 
     * [Preview API 3.0-preview.1] Get the specific pull request iteration status.
     * 
     * @param repositoryId 
     *            
     * @param pullRequestId 
    ...
    /** 
     * [Preview API 3.0-preview.1] Get the specific pull request status.
     * 
     * @param repositoryId 
     *            
     * @param pullRequestId 
    ...
    /** 
     * [Preview API 3.0-preview.1] Lock or unlock a ref.
     * 
    ...
    /** 
     * [Preview API 3.0-preview.1] Creates a ref favorite
     * 
     * @param favorite 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.0-preview.1] Gets the refs favorites for a repo and an identity.
     * 
     * @param project 
     *            Project ID or project name
     * @param repositoryId 
