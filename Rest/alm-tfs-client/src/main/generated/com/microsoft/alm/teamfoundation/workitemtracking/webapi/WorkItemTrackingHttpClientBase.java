...
public abstract class WorkItemTrackingHttpClientBase
    ...
    */
     ...
     * @return ArrayList&lt;WorkItemTemplateReference&gt;
     */
    public ArrayList<WorkItemTemplateReference> getTemplates(
        final String project, 
        final String team, 
        ...
        final NameValueCollection queryParameters = new NameValueCollection();
        queryParameters.addIfNotEmpty("workitemtypename", workitemtypename); //$NON-NLS-1$
    ...
    public WorkItemTemplate replaceTemplate(
        final WorkItemTemplate templateContent, 
        final String project, 
        final String team, 
        final UUID templateId) { 
    ...
    public ArrayList<WorkItem> getWorkItems(
        ...
        queryParameters.addIfNotNull("asOf", asOf); //$NON-NLS-1$
        queryParameters.addIfNotNull("$expand", expand); //$NON-NLS-1$
        queryParameters.addIfNotNull("errorPolicy", errorPolicy); //$NON-NLS-1$
