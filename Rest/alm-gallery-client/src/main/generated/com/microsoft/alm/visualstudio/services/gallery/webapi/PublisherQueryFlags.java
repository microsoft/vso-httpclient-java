...
public enum PublisherQueryFlags {
    ...
    */
    INCLUDE_EMAIL_ADDRESS(2),
    ;

    private int value;

    private PublisherQueryFlags(final int value) {
        this.value = value;
    }
    ...
    public String toString() {
        ...
        if (name.equals("INCLUDE_EXTENSIONS")) { //$NON-NLS-1$
            return "includeExtensions"; //$NON-NLS-1$
        }

        if (name.equals("INCLUDE_EMAIL_ADDRESS")) { //$NON-NLS-1$
            return "includeEmailAddress"; //$NON-NLS-1$
        }
